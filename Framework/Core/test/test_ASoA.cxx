...
DECLARE_SOA_TABLE(PointNGs, "TEST", "POINTS", test::X, test::Y);
DECLARE_SOA_TABLE(Points3DNGs, "TEST", "PTS3D", o2::soa::Index<>, test::X, test::Y, test::Z);

DECLARE_SOA_TABLE_VERSIONED(Points3DMk1NGs, "TEST", "PTS3D", 1, o2::soa::Index<>, o2::soa::Marker<1>, test::X, test::Y, test::Z);
DECLARE_SOA_TABLE_VERSIONED(Points3DMk2NGs, "TEST", "PTS3D", 2, o2::soa::Index<>, o2::soa::Marker<2>, test::X, test::Y, test::Z);
DECLARE_SOA_TABLE_VERSIONED(Points3DMk3NGs, "TEST", "PTS3D", 3, o2::soa::Index<>, o2::soa::Marker<3>, test::X, test::Y, test::Z);
...
DECLARE_SOA_TABLE(InfoNGs, "TEST", "INFOS", test::Color, test::SomeBool);

namespace test
{
DECLARE_SOA_COLUMN(N, n, int);
// DECLARE_SOA_INDEX_COLUMN(Info, info);
DECLARE_SOA_INDEX_COLUMN(InfoNG, infong);
// DECLARE_SOA_INDEX_COLUMN_FULL(PointA, pointA, int, Points, "_A");
// DECLARE_SOA_INDEX_COLUMN_FULL(PointB, pointB, int, Points, "_B");
DECLARE_SOA_INDEX_COLUMN_FULL(PointAng, pointAng, int, PointNGs, "_A");
DECLARE_SOA_INDEX_COLUMN_FULL(PointBng, pointBng, int, PointNGs, "_B");
...
DECLARE_SOA_TABLE(SegmentsNG, "TEST", "SEGMENTS", test::N, test::PointAngId, test::PointBngId, test::InfoNGId);
DECLARE_SOA_TABLE(SegmentsExtrasNG, "TEST", "SEGMENTSPLUS", test::Thickness);
...
DECLARE_SOA_TABLE(ListsNG, "TEST", "LISTS", o2::soa::Index<>, test::L1, test::L2);
} // namespace o2::aod
...
TEST_CASE("TestTableIterationNG")
{
  ...
  arrow::ChunkedArray* chunks[2] = {
    table->column(0).get(),
    table->column(1).get()};
  o2::aod::PointNGs::iterator tests(chunks, {table->num_rows(), 0});
  REQUIRE(tests.x() == 0);
  REQUIRE(tests.y() == 0);
  ++tests;
  REQUIRE(tests.x() == 0);
...
{
  TableBuilder builderA;
  auto pointsWriter = builderA.cursor<o2::aod::PointNGs>();
  pointsWriter(0, 0, 0);
  pointsWriter(0, 3, 4);
  auto pointsT = builderA.finalize();
  o2::aod::PointNGs points{pointsT};
  REQUIRE(pointsT->num_rows() == 2);

  TableBuilder builderA2;
  auto infoWriter = builderA2.cursor<o2::aod::InfoNGs>();
  infoWriter(0, 0, true);
  infoWriter(0, 1, false);
  infoWriter(0, 4, true);
  auto infosT = builderA2.finalize();
  o2::aod::InfoNGs infos{infosT};
  REQUIRE(infos.begin().someBool() == true);
  REQUIRE((infos.begin() + 1).someBool() == false);
  REQUIRE((infos.begin() + 2).someBool() == true);
  REQUIRE((infos.begin() + 2).color() == 4);
  ...
  static_assert(std::is_same_v<decltype(segments.begin().pointAng()), o2::aod::PointNGs::iterator>);
  auto i = segments.begin();
  using namespace o2::framework;
  i.bindExternalIndices(&points, &infos);
  REQUIRE(i.n() == 10);
...
{
  auto schema = std::make_shared<arrow::Schema>(createFieldsFromColumns(o2::aod::PointNGs::persistent_columns_t{}));
...
{
  TableBuilder bPoints;
  [[maybe_unused]] auto pwriter = bPoints.cursor<o2::aod::PointNGs>();
  auto pempty = bPoints.finalize();

  TableBuilder bInfos;
  [[maybe_unused]] auto iwriter = bInfos.cursor<o2::aod::InfoNGs>();
  auto iempty = bInfos.finalize();

  o2::aod::PointNGs p{pempty};
  o2::aod::InfoNGs i{iempty};

  using PI = Join<o2::aod::PointNGs, o2::aod::InfoNGs>;
  PI pi{{pempty, iempty}, 0};
  REQUIRE(pi.size() == 0);
  auto spawned = Extend<o2::aod::PointNGs, o2::aod::test::ESum>(p);
  REQUIRE(spawned.size() == 0);
}
...
DECLARE_SOA_TABLE(OrigintNGs, "TEST", "ORIG", o2::soa::Index<>, test::X, test::SomeBool);
namespace test
{
...
DECLARE_SOA_TABLE(ReferenceNGs, "TEST", "REFS", o2::soa::Index<>, test::OrigintNGId);
DECLARE_SOA_TABLE(OtherReferenceNGs, "TEST", "OERFS", o2::soa::Index<>, test::AltOrigintNGId);
DECLARE_SOA_TABLE(ManyReferenceNGs, "TEST", "MREFS", o2::soa::Index<>, test::OrigintNGIds);
} // namespace o2::aod
...
TEST_CASE("TestIndexToFilteredNG")
{
  ...
  expressions::Filter flt = o2::aod::test::someBool == true;
  using Flt = o2::soa::Filtered<o2::aod::OrigintNGs>;
  auto selection = expressions::createSelection(o.asArrowTable(), flt);
  Flt f{{o.asArrowTable()}, selection};
  r.bindExternalIndices(&f);
  auto it = r.begin();
...
DECLARE_SOA_TABLE(PointsRefNG, "TEST", "PTSREF", test::Points3DNGIdSlice, test::Points3DNGIds);
DECLARE_SOA_TABLE(PointsRefFNG, "TEST", "PTSREFF", test::SinglePointNGId, test::Points3DNGIdSlice, test::Points3DNGIds);
DECLARE_SOA_TABLE(PointsSelfIndexNG, "TEST", "PTSSLF", o2::soa::Index<>, test::X, test::Y, test::Z, test::OtherPointId,
                  test::PointSeqIdSlice, test::PointSetIds);
} // namespace o2::aod
...
TEST_CASE("TestAdvancedIndicesNG")
{
  ...
  using Flt = o2::soa::Filtered<o2::aod::Points3DNGs>;
  expressions::Filter fltx = (o2::aod::test::x <= -6);
  Flt f{{tpts1}, expressions::createSelection(tpts1, fltx)};
  prt.bindExternalIndices(&f);
...
DECLARE_SOA_TABLE(PointsSelfRefNG, "TEST", "PTSSR", test::OtherPointId, test::PointSeqIdSlice, test::PointSetIds);
} // namespace o2::aod
...
TEST_CASE("TestSelfIndexRecursionNG")
{
  ...
  using FullPoints = o2::soa::Join<o2::aod::Points3DNGs, o2::aod::PointsSelfRefNG>;
  TableBuilder b;
...
TEST_CASE("TestSliceByCachedNG")
{
  ...
  ArrowTableSlicingCache atscache({{o2::soa::getLabelFromType<o2::aod::ReferenceNGs>(), "fIndex" + o2::framework::cutString(o2::soa::getLabelFromType<o2::aod::OrigintNGs>())}});
  auto s = atscache.updateCacheEntry(0, refs);
  SliceCache cache{&atscache};
...
TEST_CASE("TestSliceByCachedMismatchedNG")
{
  ...
  using J = o2::soa::Join<o2::aod::ReferenceNGs, o2::aod::OtherReferenceNGs>;
  J rr{{refs, refs2}};

  auto key = "fIndex" + o2::framework::cutString(o2::soa::getLabelFromType<o2::aod::OrigintNGs>()) + "_alt";
  ArrowTableSlicingCache atscache({{o2::soa::getLabelFromTypeForKey<J>(key), key}});
  auto s = atscache.updateCacheEntry(0, refs2);
  SliceCache cache{&atscache};
...
DECLARE_SOA_TABLE(BIListNGs, "TEST", "BILISTS", o2::soa::Index<>, test::SmallIntArray, test::BoolArray);
} // namespace o2::aod
...
DECLARE_SOA_TABLE(MixTestNG, "AOD", "MIXTST",
                  table::One, table::Two, table::Three, table::Four,
                  table::Five<table::Four>);
} // namespace o2::aod
