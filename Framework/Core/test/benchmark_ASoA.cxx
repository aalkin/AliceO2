...
static void BM_ASoASimpleForLoop(benchmark::State& state)
{
  ...
  using Test = o2::soa::Table<OriginEnc{"AOD"}, test::X>;
...
static void BM_ASoASimpleForLoopWithOp(benchmark::State& state)
{
  ...
  using Test = o2::soa::Table<OriginEnc{"AOD"}, test::X, test::Y>;
...
static void BM_ASoADynamicColumnPresent(benchmark::State& state)
{
  ...
  using Test = o2::soa::Table<OriginEnc{"AOD"}, test::X, test::Y, test::Z, test::Sum<test::X, test::Y>>;
...
static void BM_ASoADynamicColumnCall(benchmark::State& state)
{
  ...
  using Test = o2::soa::Table<OriginEnc{"AOD"}, test::X, test::Y, test::Sum<test::X, test::Y>>;
