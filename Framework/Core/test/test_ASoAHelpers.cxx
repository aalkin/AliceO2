...
TEST_CASE("IteratorTuple")
{
  ...
  using TestA = o2::soa::Table<OriginEnc{"AOD"}, o2::soa::Index<>, test::X, test::Y>;
...
TEST_CASE("IteratorTupleNG")
{
  ...
  using TestA = InPlaceTableNG<0, o2::soa::Index<>, test::X, test::Y>;
  ...
  expressions::Filter filter = test::x > 3;
  auto filtered = FilteredNG<TestA>{{tests.asArrowTable()}, o2::framework::expressions::createSelection(tests.asArrowTable(), filter)};
  std::tuple<FilteredNG<TestA>, FilteredNG<TestA>> filteredTuple = std::make_tuple(filtered, filtered);
...
TEST_CASE("CombinationsGeneratorConstruction")
{
  ...
  using TestA = o2::soa::Table<OriginEnc{"AOD"}, o2::soa::Index<>, test::X, test::Y, test::FloatZ>;
  using TestB = o2::soa::Table<OriginEnc{"AOD"}, o2::soa::Index<>, test::X>;
...
TEST_CASE("CombinationsGeneratorConstructionNG")
{
  TableBuilder builderA;
  auto rowWriterA = builderA.persist<int32_t, int32_t, float>({"x", "y", "floatZ"});
  rowWriterA(0, 0, 25, -6.0f);
  ...
  using TestA = InPlaceTableNG<0, o2::soa::Index<>, test::X, test::Y, test::FloatZ>;
  using TestB = InPlaceTableNG<0, o2::soa::Index<>, test::X>;
  ...
  o2::framework::expressions::Filter filter = test::x > 3;
  auto s1 = o2::framework::expressions::createSelection(testsA.asArrowTable(), filter);
  auto filtered = FilteredNG<TestA>{{testsA.asArrowTable()}, s1};

  CombinationsGenerator<CombinationsStrictlyUpperIndexPolicy<FilteredNG<TestA>, FilteredNG<TestA>>>::CombinationsIterator combItFiltered(CombinationsStrictlyUpperIndexPolicy(filtered, filtered));
  REQUIRE(!(static_cast<test::X>(std::get<0>(*(combItFiltered))).getIterator().mCurrentPos == nullptr));
  REQUIRE(*(static_cast<test::X>(std::get<0>(*(combItFiltered))).getIterator().mCurrentPos) == 4);
  REQUIRE(static_cast<test::X>(std::get<0>(*(combItFiltered))).getIterator().mCurrentChunk == 0);
  REQUIRE(!(static_cast<test::X>(std::get<1>(*(combItFiltered))).getIterator().mCurrentPos == nullptr));
  ...
  static_assert(std::is_same_v<decltype(comb2Filter.begin()), CombinationsGenerator<CombinationsStrictlyUpperIndexPolicy<FilteredNG<TestA>, FilteredNG<TestA>>>::CombinationsIterator>, "Wrong iterator type");
  static_assert(std::is_same_v<decltype(*(comb2Filter.begin())), CombinationsStrictlyUpperIndexPolicy<FilteredNG<TestA>, FilteredNG<TestA>>::CombinationType&>, "Wrong combination type");
...
TEST_CASE("Combinations")
{
  ...
  using TestA = o2::soa::Table<OriginEnc{"AOD"}, o2::soa::Index<>, test::X, test::Y>;
  using TestB = o2::soa::Table<OriginEnc{"AOD"}, o2::soa::Index<>, test::X>;
  using TestC = o2::soa::Table<OriginEnc{"AOD"}, o2::soa::Index<>, test::X, test::Y, test::Z>;
  using ConcatTest = Concat<TestA, TestB>;
...
TEST_CASE("CombinationsNG")
{
  ...
  using TestA = InPlaceTableNG<0, o2::soa::Index<>, test::X, test::Y>;
  using TestB = InPlaceTableNG<0, o2::soa::Index<>, test::X>;
  using TestC = InPlaceTableNG<0, o2::soa::Index<>, test::X, test::Y, test::Z>;
  using ConcatTest = ConcatNG<TestA, TestB>;
...
TEST_CASE("BreakingCombinationsNG")
{
  TableBuilder builderA;
  auto rowWriterA = builderA.persist<int32_t, int32_t>({"x", "y"});
  rowWriterA(0, 0, 0);
...
TEST_CASE("SmallTableCombinationsNG")
{
  TableBuilder builderA;
  auto rowWriterA = builderA.persist<int32_t, int32_t>({"x", "y"});
  rowWriterA(0, 0, 0);
...
TEST_CASE("CombinationsHelpers")
{
  ...
  using TestB = o2::soa::Table<OriginEnc{"AOD"}, o2::soa::Index<>, test::X, test::Y, test::FloatZ>;
  TestB testB{tableB};
...
TEST_CASE("CombinationsHelpersNG")
{
  TableBuilder builderA;
  auto rowWriterA = builderA.persist<int32_t, int32_t>({"x", "y"});
  rowWriterA(0, 0, 0);
...
TEST_CASE("ConstructorsWithoutTablesNG")
{
  using TestA = InPlaceTableNG<0, o2::soa::Index<>, test::X, test::Y>;
  NoBinningPolicy<test::Y> noBinning;
...
TEST_CASE("BlockCombinationsCountersNG")
{
  TableBuilder builderA;
  auto rowWriterA = builderA.persist<int32_t, int32_t, float>({"x", "y", "floatZ"});
  rowWriterA(0, 0, 25, -1.3f);
