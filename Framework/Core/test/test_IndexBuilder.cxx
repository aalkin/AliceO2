...
DECLARE_SOA_TABLE(PointNGs, "TST", "POINTS", Index<>, coords::X, coords::Y, coords::Z);
...
DECLARE_SOA_TABLE(DistanceNGs, "TST", "DISTANCES", Index<>, extra_1::PointNGId, extra_1::D);
...
DECLARE_SOA_TABLE(FlagNGs, "TST", "Flags", Index<>, extra_2::PointNGId, extra_2::IsTrue);
...
DECLARE_SOA_TABLE(CategoryNGs, "TST", "Categories", Index<>, extra_3::PointNGId, extra_3::Category);
...
DECLARE_SOA_INDEX_TABLE(IDXNGs, PointNGs, "Index1", test_indices::PointNGId, test_indices::DistanceNGId, test_indices::FlagNGId, test_indices::CategoryNGId);
DECLARE_SOA_INDEX_TABLE(IDX2NGs, PointNGs, "Index2", test_indices::DistanceNGId, test_indices::PointNGId, test_indices::FlagNGId, test_indices::CategoryNGId);
} // namespace o2::aod
...
DECLARE_SOA_TABLE(BinnedPointNGs, "TST", "BinnedPoints", Index<>, extra_4::Bin, test_indices::PointNGId);
DECLARE_SOA_TABLE(ColoredPointNGs, "TST", "ColoredPoints", Index<>, extra_4::Color, test_indices::PointNGId);
...
DECLARE_SOA_INDEX_TABLE(IDX3NGs, PointNGs, "Index3", test_indices::PointNGId, test_indices::BinnedPointNGIdSlice, test_indices::ColoredPointNGIds);
} // namespace o2::aod
